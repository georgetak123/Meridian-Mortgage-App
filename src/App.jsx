        ...
        <div className="sb-hd">
          <div className="sb-brand">
            <div className="sb-monogram">
              <div className="sb-monogram-bg"/>
              <div className="sb-monogram-letter">M</div>
            </div>
            <div className="sb-wordmark">
              <div className="sb-firm-name">Meridian <em>Properties</em></div>
              <div className="sb-firm-type">Brooklyn, New York</div>
